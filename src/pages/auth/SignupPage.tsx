    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#0A0A0F' }}>
      ...
      <div className="w-full max-w-md animate-slide-up relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-heading font-bold text-[#F1F5F9]">Create your account</h1>
          <p className="text-[#94A3B8] text-sm mt-1">Start beating the ATS — it's free</p>
        </div>
        ...
        <div className="card" style={{ padding: '2rem' }}>
          ...
          <button onClick={handleGoogle} disabled={googleLoading} className="btn btn-ghost w-full mb-5 gap-2">
            {googleLoading ? (
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              ...
              />
              {errors.fullName && <p className="text-[#EF4444] text-xs mt-1">{errors.fullName}</p>}
            </div>
          ...
          <p className="text-center text-xs text-[#4A5568] mt-4">
            ...
            <span className="text-[#6366F1]">Terms</span> and{' '}
            <span className="text-[#6366F1]">Privacy Policy</span>
          </p>

          <p className="text-center text-sm text-[#94A3B8] mt-4">
            Already have an account?{' '}
            <Link to="/login" className="text-[#6366F1] hover:underline font-medium">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
